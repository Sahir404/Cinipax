                  ...
                  for (int i = 1 + indexOfX * (10); i < 11 + indexOfX * 10; i++)
                    GestureDetector(
                      onTap: () {
                        ...
                        seatsStateProvider.getDayBookedSeatsGold.contains(i)
                            ? null
                        ...
                        children: [
                          ...
                          Consumer<SeatsStateProvider>(
                              builder: (context, provider, _) {
                                if(provider.showGoldSeats)
                                  {
                                    return Image.asset(
                                      provider.getDayBookedSeatsGold.contains(i)
                                  ...
                                  return Image.asset(
                                      provider.getDayBookedSeatsPlat.contains(i)
                                          ? 'assets/images/booked_seat.png'
                                          : provider.getSelectedSeats.isEmpty
                                          ? 'assets/images/unbooked_seat.png'
                                          : provider.getSelectedSeats.contains(i)
